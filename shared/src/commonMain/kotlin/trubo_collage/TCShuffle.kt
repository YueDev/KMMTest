...
internal class TCShuffle {
    ...
    companion object {
        ...
        fun getTotalShuffle(ratioMap: Map<String, Double>, width: Double, height: Double): TCShuffle? {
        ...
        fun getTotalShuffle(ratioMap: Map<String, Double>): TCShuffle? {
        ...
        private fun linkAllShuffles(shuffleList: List<TCShuffle>, noUse: TCShuffle?): TCShuffle {
            val result: TCShuffle
            if (shuffleList.size == 1) {
                result = shuffleList[0]
            } else {
                val s = TCShuffle()
